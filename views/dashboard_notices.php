...
printf(
    ...
    __('Thank you for installing %1$s!', 'ad-base-modal'),
    $this->plugin->displayName
);?>
		<a href="<?php echo $setting_page; ?>"><?php esc_html_e('Click here', 'ad-base-modal');?></a> <?php esc_html_e('to configure the plugin.', 'ad-base-modal');?>
	</p>
</div>
